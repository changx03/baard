...
\begin{table}
    ...
    \begin{tabular}{@{\hskip2pt}c@{\hskip2pt}|c|ccccc|ccccc}
        \toprule
                                                   &                                       & \multicolumn{5}{c}{AUC-ROC (\%)} & \multicolumn{5}{c}{TPR@FPR5 (\%)}                                                                                                                                                                                                       \\
        ...
        \midrule
        \textbf{Image data}                        & \diagbox{Detector}{Attack $\epsilon$} & Low                              & High                              & Low                     & High                             &                                & Low                     & High             & Low               & High             &                   \\
        \midrule
        \multirow{7}{*}{\begin{tabular}[c]{@{}l@{}}MNIST\\ (CNN)\end{tabular}} & RC                                    & 73.3                             & {\color{red}51.6}                 & {\color{red}50.8}       & {\color{red}51.2}                & \textbf{99.9}                  & 49.6                    & {\color{red}0.0} & {\color{red}0.0}  & {\color{red}0.0} & \textbf{100.0}    \\
        ...
        \midrule
        \multirow{7}{*}{\begin{tabular}[c]{@{}l@{}}CIFAR10\\ (ResNet18)\end{tabular}} & RC                                    & {\color{red}50.2}                & {\color{red}54.8}                 & 56.8                    & {\color{red}55.0}                & \textbf{99.4}                  & {\color{red}3.7}        & {\color{red}0.0} & {\color{red}13.4} & {\color{red}0.0} & \textbf{98.5}     \\
