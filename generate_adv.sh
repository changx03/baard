...
python ./experiments/train_adv_examples.py -d=CIFAR10 --attack=FGSM --params='{"norm":2}' --eps="[0.01,0.02,0.03,0.09,0.16,0.22,0.28,0.34,0.41,0.47,0.53,0.59,0.66]"

# Data:CIFAR10,Attack:PGD
python ./experiments/train_adv_examples.py -d=CIFAR10 --attack=PGD --params='{"norm":"inf","eps_iter":0.03}' --eps="[0.01,0.02,0.03,0.05,0.06,0.08,0.09,0.11,0.12]"
python ./experiments/train_adv_examples.py -d=CIFAR10 --attack=PGD --params='{"norm":2,"eps_iter":0.1}' --eps="[0.01,0.02,0.03,0.09,0.16,0.22,0.28,0.34,0.41,0.47,0.53,0.59,0.66]"

# Data:CIFAR10,Attack:APGD
python ./experiments/train_adv_examples.py -d=CIFAR10 --attack=APGD --params='{"norm":"inf","eps_iter":0.03}' --eps="[0.01,0.02,0.03,0.05,0.06,0.08,0.09,0.11,0.12]"
python ./experiments/train_adv_examples.py -d=CIFAR10 --attack=APGD --params='{"norm":2,"eps_iter":0.1}' --eps="[0.01,0.02,0.03,0.09,0.16,0.22,0.28,0.34,0.41,0.47,0.53,0.59,0.66]"
