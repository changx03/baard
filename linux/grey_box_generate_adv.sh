...
for SEED in ${SEEDS[@]}; do
    ...
    python ./experiments/train_adv_examples.py --seed=$SEED --n_att=$SIZE --n_val=$SIZE -d=$DATA --attack=APGD --params='{"norm":2,"eps_iter":0.1}' --eps="[4.0,8.0]"
    # Attack:CW2
    python ./experiments/train_adv_examples.py --seed=$SEED --n_att=$SIZE --n_val=$SIZE -d=$DATA --attack=CW2 --params='{"max_iterations":200}' --eps="[0.0]"
    ...
    python ./experiments/train_adv_examples.py --seed=$SEED --n_att=$SIZE --n_val=$SIZE -d=$DATA --attack=APGD --params='{"norm":2,"eps_iter":0.05}' --eps="[0.3,3.0]"
    # Attack:CW2
    python ./experiments/train_adv_examples.py --seed=$SEED --n_att=$SIZE --n_val=$SIZE -d=$DATA --attack=CW2 --params='{"max_iterations":200}' --eps="[0.0]"
done
